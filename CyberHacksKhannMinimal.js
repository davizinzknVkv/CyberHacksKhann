...
document.querySelector("link[rel~='icon']").href = 'https://media.discordapp.net/attachments/1433542676221006076/1433544648030163165/thefinal-removebg-preview.png?ex=690513fe&is=6903c27e&hm=a5fce921213492d4967d53adf5dae43977e5706c4e7c83daee23758733324289&=&format=webp&quality=lossless';
...
/* Inject */
if (!/^https?:\/\/([a-z0-9-]+\.)?khanacademy\.org/.test(window.location.href)) { alert("❌ CYBERHACKS Failed to Injected!\n\nVocê precisa executar o CYBERHACKS no site do Khan Academy! (https://pt.khanacademy.org/)"); window.location.href = "https://pt.khanacademy.org/"; }
...
.then(async () => {    
    sendToast("🤖 CyberHacksKhan Minimal injetado com sucesso!");
