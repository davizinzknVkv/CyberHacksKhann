...
.then(async () => {
    ...
    sendToast("🤖CyberHacksKhan injetado com sucesso!");
    ...
    if(device.apple) { await delay(500); sendToast(`🪽 Que tal comprar um Samsung seu animal?`); }
