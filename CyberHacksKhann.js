...
document.querySelector("link[rel~='icon']").href = 'https://media.discordapp.net/attachments/1432194657206669472/1439448300066570322/thefinal-removebg-preview.png?ex=691a8e32&is=69193cb2&hm=29b8e85a0d43c7951e4f27f0b337e6cfa7f74cc6bea4d6edec4d61f4502bbc6c&=&format=webp&quality=lossless';
...
.then(async () => {
    ...
    sendToast("👾 CyberHacks injetado com sucesso!");
    ...
    if(device.apple) { await delay(500); sendToast(`🪽 Que tal comprar um Samsung Seu Pobre?`); }
